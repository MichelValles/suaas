import { z } from "zod";
import { ProfileInputSchema, type ProfileInput } from "@/lib/profiles";
...
export const ProfileFormSchema = z.object({
  ...
  age: z.coerce
    ...
    .int("Edad debe ser un número entero (sin decimales)")
...
export function parseProfileForm(
  ...
  const result = ProfileFormSchema.safeParse(Object.fromEntries(formData));
  if (!result.success) {
