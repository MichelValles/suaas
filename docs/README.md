...
| [`CONOCIMIENTO-USUARIOS-SINTETICOS.md`](./CONOCIMIENTO-USUARIOS-SINTETICOS.md) | Base teórica del **motor**: vignettes grounded, Talker-Reasoner, métricas, riesgos. Fuente fundacional de la plataforma. Saneado en v0.61.16 (markdown renderizable, formato español); sus cifras siguen sin referencia formal recuperada y el contraste teoría↔implementación vive en `PERFILES-CALIBRADOS.md`. |
| [`GRAVITY-MODEL.md`](./GRAVITY-MODEL.md) | Base teórica del **marco estratégico** con la tesis rectora «la decisión se toma antes del clic» como hilo conductor: Intent Momentum (con su ancla académica en la teoría de campo de Lewin), los tres planos de influencia (eje pre-clic / post-clic), hipersegmentación JTBD, instancias, conductas óptima/fuga/repesca, GEO, propiedad psicológica. Incluye los controles experimentales de la certeza predictiva, el mapa teoría → implementación verificado contra v0.61.15 (con el estado del vector momentum y las dos semánticas de `behavior_class`) y los huecos pendientes. |
| [`PERFILES-CALIBRADOS.md`](./PERFILES-CALIBRADOS.md) | **El motor de perfiles al detalle, para una audiencia experta en Behavioural Economics y sociología**: anatomía completa del perfil (esquema, cuatro vías de creación, sets IVI/Adeslas), fundamento académico de cada componente (Big Five, HEXACO-24, COM-B, JTBD, vignettes, Intent Momentum, Talker-Reasoner, controles experimentales) con autores canónicos, tabla de fidelidad por módulo, doctrina sin implementar, qué citar y qué no, críticas metodológicas anticipadas y guion de síntesis. Verificado contra v0.61.15 con citas archivo:línea. |
