...
| Momentum/Triggers | Reconocimiento del problema y búsqueda de información; trigger | Engel, Kollat y Blackwell (1968); Howard y Sheth (1969); Fogg (2009) | Media, con brecha de fidelidad grave (ver 5.6) |
...
| **Momentum/Triggers** | **No** | Una pasada por perfil, prompt propio | No | **Sí, por escenario** | **Omite Big Five, COM-B y todos los negative prompts** |
...
7. Las dos incoherencias internas a reconocer si salen: el módulo Momentum omite la mitad de la calibración del perfil, y `willingness_to_pay` mide justicia de precio, no disposición a pagar.
