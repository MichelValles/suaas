...
> Última actualización: 2026-07-22 tras v0.75.0. Sesión larga: rediseño del sidebar, normalización de cards, perfiles con cliente de optimización, capa de observabilidad + evaluación de calidad de salidas (con persistencia), cierre de las dos deudas de honestidad (pricing, momentum), el juez de calidad llevado a los tests por lotes (5s + campañas + Momentum) y un refinamiento de fidelidad en cinco módulos.

## Estado actual (v0.75.0 desplegada)
