...
lib/
  ...
  profiles.ts                           ProfileInputSchema + CRUD (create / update / get / list / listByIds / softDelete / restore / hardDelete / updateProfileOptimizedFor) + listClientSuggestions (marcas Cerebro + GEO para el datalist de «optimizado para»)
